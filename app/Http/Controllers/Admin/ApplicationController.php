    ...
    private function getFilteredApplications(string $type, string $status)
    {
        ...
        if ($status !== 'all') {
            $statusMap = [
                ...
                'additional_info_required' => ApplicationStatus::AdditionalInfoRequired,
    ...
    private function getApplicationCounts(): array
    {
        ...
        return [
            'individual' => [
                ...
                'additional_info_required' => $statusCounts[Individual::class][ApplicationStatus::AdditionalInfoRequired->value][0]->count ?? 0,
            ...
            'company' => [
                ...
                'additional_info_required' => $statusCounts[Company::class][ApplicationStatus::AdditionalInfoRequired->value][0]->count ?? 0,
            ...
            'total' => [
                ...
                'additional_info_required' => Application::where('status', ApplicationStatus::AdditionalInfoRequired)->count(),
