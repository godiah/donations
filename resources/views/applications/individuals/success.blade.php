                ...
                <div class="p-8 bg-white">
                    ...
                    <div class="mb-8 text-center">
                        ...
                        <p class="mb-6 text-lg text-gray-600">
                            Your individual donation application has been received and is now under review.
                        </p>
                    </div>
                    ...
                    <div class="p-6 mb-8 rounded-lg bg-gray-50">
                        ...
                        <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
                            ...
                            <div>
                                ...
                                <p class="mt-1 text-lg text-gray-900">{{ $application->applicant->contribution_name }}
                                </p>
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-500">Target Amount</label>
                                <p class="mt-1 text-lg text-gray-900">KES
                                    {{ number_format($application->applicant->target_amount, 2) }}</p>
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-500">Beneficiary</label>
                                <p class="mt-1 text-lg text-gray-900">{{ $application->applicant->full_name }}</p>
                            </div>
                            <div>
                    ...
                    <div class="p-6 mb-8 border border-blue-200 rounded-lg bg-blue-50">
                        ...
                        <div class="space-y-3">
                            <div class="flex items-start">
                                ...
                                <div class="ml-3">
                                    <p class="text-blue-800">
                                        <strong>Review Process:</strong> Our team will review your application and
                                        supporting documents within 3-5 business days.
                                    </p>
                                </div>
                            </div>
                            <div class="flex items-start">
                                ...
                                <div class="ml-3">
                                    <p class="text-blue-800">
                                        ...
                                        <strong>{{ $application->applicant->email }}</strong> regarding your application
                                        status.
                                    </p>
                                </div>
                            </div>
                            <div class="flex items-start">
                                ...
                                <div class="ml-3">
                                    <p class="text-blue-800">
                                        <strong>Approval & Launch:</strong> Once approved, your donation campaign will
                                        go live and you can start sharing it with potential donors.
                                    </p>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="mt-2 text-sm text-amber-700">
                                    <ul class="space-y-1 list-disc list-inside">
                                        <li>Keep your application number
                                            <strong>{{ $application->application_number }}</strong> for future reference
                                        </li>
                    ...
                    <div class="flex flex-col justify-center gap-4 sm:flex-row">
                        <a href="{{ route('dashboard') }}"
                            class="inline-flex items-center justify-center px-6 py-3 text-base font-medium text-white bg-blue-600 border border-transparent rounded-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
